...
<input  name="<?=$targetValueField ?>" id="<?=$targetValueField ?>"  style="display: none" value="<?= $value ?>" />
...
<div>
    ...
    <span class="btn btn-success fileinput-button">
        ...
        <!-- The file input field used as target for the file upload widget -->
                            <input id="fileupload<?= $targetValueField ?>" type="file" name="pic" />
                        </span>
    <br/>
    ...
    <div id="files<?= $targetValueField ?>" class="files"></div>
</div>
...
<script>
    ...
    $(function () {
        ...
        $('#fileupload<?= $targetValueField ?>').fileupload({
            url: url,
            dataType: 'json',
            autoUpload: true,
            acceptFileTypes: /(\.|\/)(.*)$/i,
            ...
            data.context = $('<div/>').appendTo('#files<?= $targetValueField ?>');
            ...
            $.each(data.result.files, function (index, file) {
                ...
                if (file.url) {
                    ...
                    //$('#<?=$targetValueField ?>').val(file.url);

                    $(document.getElementById("<?=$targetValueField ?>")).val(file.url);
