...
<table cellpadding="2" cellspacing="1" width="98%">
    ...
    <tr>
        <td>是否从已上传中选择</td>
        <td><label><input type="radio" name="setting[isselectfile]" value="1"> 是</label> <label><input type="radio" name="setting[isselectimage]" value="0" checked> 否</label></td>
    </tr>
    <tr>
        <td>允许同时上传的个数</td>
    ...
    <tr>
        ...
        <td>
            <label><input name="setting[downloadtype]" value="0" type="radio">
                链接文件地址</label>
            <label style="margin-left: 43px"><input name="setting[downloadtype]" value="1" checked="checked" type="radio">
                通过PHP读取</label>
        </td></tr>
</table>